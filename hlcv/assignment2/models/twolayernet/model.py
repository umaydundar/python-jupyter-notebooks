...
class TwoLayerNetv2(TwoLayerNetv1):
    ...
    def compute_loss(self, X, y=None, reg=0.0):
        ...
        #############################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        softmax_scores = TwoLayerNetv1.forward(self, X)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ...
        data_loss = -np.sum(np.log(correct_class_scores)) / N
...
class TwoLayerNetv3(TwoLayerNetv2):
    ...
    def back_propagation(self, X, y=None, reg=0.0):
        ...
        #############################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        loss = TwoLayerNetv2.compute_loss(self, X, y)
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ...
        # Gradient of W2
        grads['W2'] = np.dot(a1.T, delta3) + 2 * reg * W2
        ...
        # Gradient of W1
        grads['W1'] = np.dot(X.T, delta2) + 2 * reg * W1
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            for key in self.params:
              parameter = self.params[key]
              parameter = parameter - learning_rate * grads[key]
